...
class Usuario(models.Model):
    sub = models.CharField(max_length=255, unique=True)  # ID único de Auth0
    name = models.CharField(max_length=255)  # Nombre del usuario
    email = models.EmailField(max_length=255, unique=True)  # Correo electrónico
    picture = models.URLField()  # Foto de perfil
    nickname = models.CharField(max_length=100, null=True, blank=True)  # Nombre de usuario (si existe)
